...
export default () => (
    <section id="coc" className="coc">
        <Container size={Sizes.medium}>
            ...
            <p>
                <b>Conference participants violating these rules may be sanctioned or expelled from the conference without a refund at the discretion of the conference organisers.</b>
            </p>
            ...
            <p>
                ...
                <br />
                <br />
                - Contacting Christian Barra <br />
                - Email: barrachri+berlinpythonpizza@gmail.com <br />
            ...
            <p>
                You can make an anonymous report <a href="https://goo.gl/forms/IUXFQVNtET7eg4Or1">here</a>.
            </p>
            <p>
